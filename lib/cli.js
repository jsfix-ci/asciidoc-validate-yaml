...
async function cli() {
  ...
  .option('--pass','Always succeed regardless of any validation failures').preset(false)
  .option('--stdin','Read file list from stdin instead of _topic_map.yml').preset(false)
